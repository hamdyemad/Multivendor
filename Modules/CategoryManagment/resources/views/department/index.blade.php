...
@section('content')
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="active" class="il-gray fs-14 fw-500 mb-10">{{ trans('categorymanagment::department.activation') }}</label>
                                                <select class="form-control ih-medium ip-gray radius-xs b-light px-15" 
                                                        id="active">
                                                    <option value="">{{ trans('categorymanagment::department.all') }}</option>
                                                    <option value="1">{{ trans('categorymanagment::department.active') }}</option>
                                                    <option value="0">{{ trans('categorymanagment::department.inactive') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                        ...
                        <table id="departmentsDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th>
                                        <span class="userDatatable-title">{{ trans('categorymanagment::department.image') }}</span>
                                    </th>
                                    ...
                                    @endforeach
                                    <th>
                                        <span class="userDatatable-title">{{ trans('categorymanagment::department.activation') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ trans('categorymanagment::department.created_at') }}</span>
                                    </th>
                                    <th>
    ...
    <x-delete-with-loading
        modalId="modal-delete-department"
        tableId="departmentsDataTable"
        deleteButtonClass="delete-department"
        :title="__('main.confirm delete')"
        :message="__('main.are you sure you want to delete this')"
        itemNameId="delete-department-name"
        ...
        var table = $('#departmentsDataTable').DataTable({
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        if (data) {
                            return '<img src="{{ asset('storage/') }}/' + data + '" alt="Department Image" class="img-thumbnail" style="width: 50px; height: 50px; object-fit: cover;">';
                        }
