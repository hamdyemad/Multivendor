...
<?php $__env->startSection('title', trans('categorymanagment::department.view_department')); ?>
            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-header bg-white border-bottom py-20 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-500"><?php echo e(trans('categorymanagment::department.department_details')); ?></h5>
                        <div class="d-flex gap-10">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('departments.edit')): ?>
                                <a href="<?php echo e(route('admin.category-management.departments.edit', $department->id)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.translation-display','data' => ['label' => trans('categorymanagment::department.name'),'model' => $department,'fieldName' => 'name','languages' => $languages]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::department.name')),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($department),'fieldName' => 'name','languages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($languages)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('categorymanagment::department.description')),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($department),'fieldName' => 'description','languages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($languages)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5a3093cad4b0bccb881a74044179ded)): ?>
<?php $attributes = $__attributesOriginale5a3093cad4b0bccb881a74044179ded; ?>
...
<?php endif; ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label
                                                        class="il-gray fs-14 fw-500 mb-10"><?php echo e(trans('categorymanagment::department.commission')); ?></label>
                                                    <p class="fs-15 color-dark">
                                                        <?php echo e($department->commission ? $department->commission . '%' : '0%'); ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    ...
                                                    <p class="fs-15">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($department->active): ?>
                                                            <span
                                                                class="badge badge-success badge-round badge-lg"><?php echo e(trans('categorymanagment::department.active')); ?></span>
                                                        <?php else: ?>
                                                            <span
                                                                class="badge badge-danger badge-round badge-lg"><?php echo e(trans('categorymanagment::department.inactive')); ?></span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    ...
                                                    <p class="fs-15 color-dark"><?php echo e($department->created_at); ?></p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    ...
                                                    <p class="fs-15 color-dark"><?php echo e($department->updated_at); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 order-1 order-md-2">
                                <div class="card card-holder">
                                    <div class="card-header">
                                        <h3>
                                            <i
                                                class="uil uil-image me-1"></i><?php echo e(trans('categorymanagment::department.image')); ?>

                                        </h3>
                                    </div>
                                    <div class="card-body text-center">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($department->image): ?>
                                            <div class="image-wrapper">
                                                <img src="<?php echo e(asset('storage/' . $department->image)); ?>"
                                                    alt="<?php echo e($department->getTranslation('name', app()->getLocale())); ?>"
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/CategoryManagment\resources/views/department/view.blade.php ENDPATH**/ ?>