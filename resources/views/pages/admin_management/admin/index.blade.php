...
@section('content')
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="active" class="il-gray fs-14 fw-500 mb-10">{{ __('admin.status') }}</label>
                        ...
                        <table id="adminsDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    @endforeach
                                    <th>
                                        <span class="userDatatable-title">{{ __('admin.email') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('admin.role') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('admin.active') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('admin.created_at') }}</span>
                                    </th>
                                    <th>
    ...
    <x-delete-modal 
        ...
        :message="__('admin.delete_confirmation')"
        ...
        :deleteText="__('admin.delete_admin')"
    />
@endsection
    ...
    let table = $('#adminsDataTable').DataTable({
        ...
        columns: [
            ...
            { 
                ...
                orderable: true,
                render: function(data, type, row) {
                    return '<div class="userDatatable-content text-lowercase">' + data + '</div>';
                }
            },
            { 
                data: 'role',
                ...
                render: function(data, type, row) {
                    return `
                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap justify-content-start">
                            <li>
                                <a href="{{ route('admin.admin-management.admins.index') }}/${row.id}" class="view">
                                    <i class="uil uil-eye"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.admin-management.admins.index') }}/${row.id}/edit" class="edit">
