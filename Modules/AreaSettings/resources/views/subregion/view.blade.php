                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <x-translation-display :label="__('areasettings::subregion.name')" :model="$subregion" fieldName="name" :languages="$languages" />
                                            <div class="col-md-6">
                                                <div class="view-item">
                                            ...
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label class="il-gray fs-14 fw-500 mb-10">{{ __('areasettings::subregion.activation') }}</label>
                                                    <p class="fs-15">
                                                        @if($subregion->active)
                                                            <span class="badge badge-success badge-round badge-lg">{{ __('areasettings::subregion.active') }}</span>
                                                        @else
                                                            <span class="badge badge-danger badge-round badge-lg">{{ __('areasettings::subregion.inactive') }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    ...
                                                    <p class="fs-15 color-dark">{{ $subregion->created_at }}</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="view-item">
                                                    <label class="il-gray fs-14 fw-500 mb-10">{{ trans('common.updated_at') }}</label>
                                                    <p class="fs-15 color-dark">{{ $subregion->updated_at }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
