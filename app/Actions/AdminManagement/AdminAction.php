...
namespace App\Actions\AdminManagement;
...
class AdminAction
{
    ...
    public function datatable(Request $request)
    {
        ...
        $sortedQuery = $this->adminService->getAdminsQuery($filters, $orderBy, $orderDirection);
        
        // Apply pagination
        $perPage = $request->get('per_page', 10);
        $page = $request->get('page', 1);
        $admins = $sortedQuery->paginate($perPage, ['*'], 'page', $page);
