...
<?php $__env->startSection('title', __('accounting.vendor_balance_overview')); ?>
                    ...
                    <div class="breadcrumb-action justify-content-center flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?php echo e(__('accounting.vendor_balance_overview')); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="userDatatable global-shadow border-light-0 p-30 bg-white radius-xl w-100 mb-30">
                    <div class="d-flex justify-content-between align-items-center mb-25">
                        <h4 class="mb-0 fw-500 fw-bold"><?php echo e(__('accounting.vendor_balance_overview')); ?></h4>
                    </div>
                                ...
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" id="search" placeholder="<?php echo e(__('accounting.search_vendors')); ?>..." autocomplete="off">
                                        </div>
                                    </div>
                        ...
                        <table id="vendorBalancesDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.vendor_information')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.total_earnings')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.commission_deducted')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.available_balance')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.total_withdrawn')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.actual_available_balance')); ?></span></th>
                                    <th><span class="userDatatable-title"><?php echo e(__('accounting.last_updated')); ?></span></th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            let table = $('#vendorBalancesDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('admin.accounting.vendor-balances.datatable')); ?>',
                    type: 'GET',
                    data: function(d) {
                        d.per_page = d.length;
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\Modules/Accounting\resources/views/vendor-balances.blade.php ENDPATH**/ ?>