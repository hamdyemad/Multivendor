...
use Modules\Brands\app\Actions\BrandAction;
...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('brands::brand.index', compact('languages'));
    }
    ...
    {
        $languages = $this->languageService->getAll();
        return view('brands::brand.form', compact('languages'));
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            $languages = $this->languageService->getAll();
            return view('brands::brand.view', compact('brand', 'languages'));
        } catch (\Exception $e) {
            return redirect()->route('admin.brands.index')
    ...
    public function edit(string $id)
    {
        try {
            $languages = $this->languageService->getAll();
            $brand = $this->brandService->getBrandById($id);
            return view('brands::brand.form', compact('brand', 'languages'));
        } catch (\Exception $e) {
            return redirect()->route('admin.brands.index')
                ->with('error', __('brand.not_found'));
        }
