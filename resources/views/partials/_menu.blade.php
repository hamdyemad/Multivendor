@php
    ...
    if (!function_exists('getBadgeStyle')) {
        ...
        {
            $brandingColor = $color === 'secondary' ? config('branding.colors.secondary') : config('branding.colors.primary');
    ...
    <ul class="sidebar_nav">
            ...
            <ul class="px-0">
                @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                    ...
                    <li>
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.allTransactions', $currentRoute) ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.allTransactions', $currentRoute)) }}">{{ $all_transactions }}</span>
                        </a>
                    </li>
                @endif
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'new' ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'new') }}">{{ $new_transactions }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'accepted' ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'accepted') }}">{{ $accepted_transactions }}</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'rejected' ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.transactionsRequests', $currentRoute) && request()->route('status') === 'rejected', 'secondary') }}">{{ $rejected_transactions }}</span>
                    </a>
                </li>
                        ...
                        @can('departments.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.category-management.departments.index', $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.category-management.departments.index', $currentRoute)) }}">
                        ...
                        @can('categories.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.category-management.categories.index', $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.category-management.categories.index', $currentRoute)) }}">
                        ...
                        @can('sub_categories.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.category-management.subcategories.index', $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.category-management.subcategories.index', $currentRoute)) }}">
            ...
            <ul class="px-0">
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.products.bank', $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.products.bank', $currentRoute)) }}">
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.products.index', 'admin.products.create', 'admin.products.show', 'admin.products.edit'], $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.products.index', 'admin.products.create', 'admin.products.show', 'admin.products.edit'], $currentRoute)) }}">
                            @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.products.pending', $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.products.pending', $currentRoute)) }}">
                            @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.products.rejected', $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.products.rejected', $currentRoute), 'secondary') }}">
                            @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.products.accepted', $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.products.accepted', $currentRoute)) }}">
                            @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                    ...
                    @canany(['variant-keys.view', 'variant-keys.create'])
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.variant-keys.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.variant-keys.index', $currentRoute)) }}">{{ \Modules\CatalogManagement\app\Models\VariantConfigurationKey::count() }}</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.variants-configurations.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.variants-configurations.index', $currentRoute)) }}">{{ \Modules\CatalogManagement\app\Models\VariantsConfiguration::count() }}</span>
                            </a>
                        </li>
                    @endcanany
                @endif
            ...
            <ul class="px-0">
                @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
                    <li>
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.bundle-categories.index', 'admin.bundle-categories.create', 'admin.bundle-categories.show', 'admin.bundle-categories.edit'], $currentRoute) ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.bundle-categories.index', 'admin.bundle-categories.create', 'admin.bundle-categories.show', 'admin.bundle-categories.edit'], $currentRoute)) }}">
                ...
                <li>
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.bundles.index', 'admin.bundles.create', 'admin.bundles.show', 'admin.bundles.edit'], $currentRoute) ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.bundles.index', 'admin.bundles.create', 'admin.bundles.show', 'admin.bundles.edit'], $currentRoute)) }}">
                            @if (in_array($user_type_id, \App\Models\UserType::adminIds()))
        ...
        <li
            ...
            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.occasions.index', 'admin.occasions.create', 'admin.occasions.show', 'admin.occasions.edit'], $currentRoute) ? 'active' : '' }}"
                ...
                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.occasions.index', 'admin.occasions.create', 'admin.occasions.show', 'admin.occasions.edit'], $currentRoute)) }}">
                    @php
                ...
                <ul class="px-0">
                    <li>
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'all' ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'all') }}">{{ $reviews_all }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'approved' ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'approved') }}">{{ $reviews_accepted }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'rejected' ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.reviews.index', $currentRoute) && request()->query('status') === 'rejected', 'secondary') }}">{{ $reviews_rejected }}</span>
                        </a>
                    </li>
                </ul>
            </li>
                        ...
                        @can('taxes.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.taxes.index', 'admin.taxes.show', 'admin.taxes.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.taxes.index', 'admin.taxes.show', 'admin.taxes.edit'], $currentRoute)) }}">{{ \Modules\CatalogManagement\app\Models\Tax::count() }}</span>
                                </a>
                            </li>
                        @endcan
            ...
            <li>
                <a href="{{ route('admin.brands.index') }}"
                    ...
                    <span class="d-flex align-items-center justify-content-between fw-bold w-100">
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.brands.index', 'admin.brands.create', 'admin.brands.show', 'admin.brands.edit'], $currentRoute)) }}">{{ \Modules\CatalogManagement\app\Models\Brand::count() }}</span>
                    </span>
                </a>
            </li>
        @endcan
                ...
                <li>
                    <a href="{{ route('admin.promocodes.index') }}"
                        ...
                        <span class="d-flex align-items-center justify-content-between fw-bold w-100">
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.promocodes.index', 'admin.promocodes.create', 'admin.promocodes.edit', 'admin.promocodes.show'], $currentRoute)) }}">{{ \Modules\CatalogManagement\app\Models\Promocode::count() }}</span>
                        </span>
                    </a>
                </li>
            @endcan
                        ...
                        @can('vendors.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.vendors.index', 'admin.vendors.show', 'admin.vendors.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.vendors.index', 'admin.vendors.show', 'admin.vendors.edit'], $currentRoute)) }}">
                    ...
                    <ul class="px-0">
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.vendor-requests.index', $currentRoute) && !request()->has('status') ? 'active' : '' }}"
                                ...
                                {{ trans('common.all') }}
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.vendor-requests.index', $currentRoute) && !request()->has('status')) }}">{{ \Modules\Vendor\app\Models\VendorRequest::count() }}</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.vendor-requests.index', $currentRoute) && !request()->has('status') ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.vendor-requests.index', $currentRoute) && !request()->has('status')) }}">{{ \Modules\Vendor\app\Models\VendorRequest::pending()->count() }}</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ request()->get('status') === 'approved' ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(request()->get('status') === 'approved') }}">{{ \Modules\Vendor\app\Models\VendorRequest::approved()->count() }}</span>
                            </a>
                        </li>
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ request()->get('status') === 'rejected' ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(request()->get('status') === 'rejected', 'secondary') }}">{{ \Modules\Vendor\app\Models\VendorRequest::rejected()->count() }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="px-0">
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.customers.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.customers.index', $currentRoute)) }}">{{ \Modules\Customer\app\Models\Customer::count() }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="px-0">
                <li class="l_sidebar">
                    <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.orders.index', $currentRoute) && !request()->has('stage') ? 'active' : '' }}"
                        ...
                        <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.orders.index', $currentRoute) && !request()->has('stage')) }}">{{ \Modules\Order\app\Models\Order::count() }}</span>
                    </a>
                </li>
                <li class="l_sidebar">
                ...
                @php
                    ...
                    $orderStages = \Modules\Order\app\Models\OrderStage::where(function ($q) use ($countryId) {
                ...
                @foreach ($orderStages as $stage)
                    <li class="l_sidebar">
                        <a class="d-flex align-items-center justify-content-between fw-bold {{ request()->get('stage') == $stage->id ? 'active' : '' }}"
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(request()->get('stage') == $stage->id) }}">{{ \Modules\Order\app\Models\Order::where('stage_id', $stage->id)->count() }}</span>
                        </a>
                    </li>
                @endforeach
            </ul>
        ...
        @can('order-stages.index')
            <li>
                <a href="{{ route('admin.order-stages.index') }}"
                    ...
                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.order-stages.index', $currentRoute)) }}">{{ $orderStages->count() }}</span>
                </a>
            </li>
        @endcan
                ...
                <li>
                    <a href="{{ route('admin.shippings.index') }}"
                        ...
                        <span class="d-flex align-items-center justify-content-between fw-bold w-100">
                            ...
                            <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.shippings.index', $currentRoute)) }}">{{ \Modules\Order\app\Models\Shipping::count() }}</span>
                        </span>
                    </a>
                </li>
            @endcan
        ...
        @if (isAdmin())
                    ...
                    <ul class="px-0">
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.system-settings.blog-categories.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.system-settings.blog-categories.index', $currentRoute)) }}">
                                    @php
                                        try {
                        ...
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.system-settings.blogs.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.system-settings.blogs.index', $currentRoute)) }}">
                                    @php
                                        try {
            ...
            <li class="{{ isMenuActive('admin.messages.index', $currentRoute) ? 'active' : '' }}">
                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.messages.index', $currentRoute) ? 'active' : '' }}"
                    ...
                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.messages.index', $currentRoute)) }}">
                    ...
                    <ul class="px-0">
                        <li>
                            <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive('admin.system-settings.ads.index', $currentRoute) ? 'active' : '' }}"
                                ...
                                <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive('admin.system-settings.ads.index', $currentRoute)) }}">
                        ...
                        @can('area.country.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.area-settings.countries.index', 'admin.area-settings.countries.create', 'admin.area-settings.countries.show', 'admin.area-settings.countries.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.area-settings.countries.index', 'admin.area-settings.countries.create', 'admin.area-settings.countries.show', 'admin.area-settings.countries.edit'], $currentRoute)) }}">{{ \Modules\AreaSettings\app\Models\Country::count() }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('area.city.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.area-settings.cities.index', 'admin.area-settings.cities.create', 'admin.area-settings.cities.show', 'admin.area-settings.cities.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.area-settings.cities.index', 'admin.area-settings.cities.create', 'admin.area-settings.cities.show', 'admin.area-settings.cities.edit'], $currentRoute)) }}">{{ \Modules\AreaSettings\app\Models\City::count() }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('area.region.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.area-settings.regions.index', 'admin.area-settings.regions.create', 'admin.area-settings.regions.show', 'admin.area-settings.regions.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.area-settings.regions.index', 'admin.area-settings.regions.create', 'admin.area-settings.regions.show', 'admin.area-settings.regions.edit'], $currentRoute)) }}">{{ \Modules\AreaSettings\app\Models\Region::count() }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('area.subregion.index')
                            <li>
                                <a class="d-flex align-items-center justify-content-between fw-bold {{ isMenuActive(['admin.area-settings.subregions.index', 'admin.area-settings.subregions.create', 'admin.area-settings.subregions.show', 'admin.area-settings.subregions.edit'], $currentRoute) ? 'active' : '' }}"
                                    ...
                                    <span class="badge badge-round ms-1" style="{{ getBadgeStyle(isMenuActive(['admin.area-settings.subregions.index', 'admin.area-settings.subregions.create', 'admin.area-settings.subregions.show', 'admin.area-settings.subregions.edit'], $currentRoute)) }}">{{ \Modules\AreaSettings\app\Models\SubRegion::count() }}</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
