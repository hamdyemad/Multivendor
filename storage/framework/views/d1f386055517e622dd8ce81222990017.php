...
<head>
    ...
    <title><?php echo e($title); ?> - Bnaia</title>
...
<body>
    <main class="main-content">
        <div class="admin" style="background-image:url(<?php echo e(asset('assets/img/admin-bg-light.png')); ?>);">
...
<?php /**PATH C:\laragon\www\eramo-multi-vendor\resources\views/auth/layout.blade.php ENDPATH**/ ?>