...
@section('content')
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       id="search" 
                                                       placeholder="{{ trans('catalogmanagement::tax.search_by_name') }}"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="active" class="il-gray fs-14 fw-500 mb-10">{{ trans('catalogmanagement::tax.activation') }}</label>
                                                <select class="form-control ih-medium ip-gray radius-xs b-light px-15" 
                                                        id="active">
                                                    <option value="">{{ trans('catalogmanagement::tax.all') }}</option>
                                                    <option value="1">{{ trans('catalogmanagement::tax.active') }}</option>
                                                    <option value="0">{{ trans('catalogmanagement::tax.inactive') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                        ...
                        <table id="taxesDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    @endforeach
                                    <th>
                                        <span class="userDatatable-title">{{ trans('catalogmanagement::tax.tax_rate') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ trans('catalogmanagement::tax.activation') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ trans('catalogmanagement::tax.created_at') }}</span>
                                    </th>
                                    <th>
    ...
    <x-delete-with-loading
        modalId="modal-delete-tax"
        tableId="taxesDataTable"
        deleteButtonClass="delete-tax"
        :title="__('main.confirm delete')"
        :message="__('main.are you sure you want to delete this')"
        itemNameId="delete-tax-name"
