        ...
        <div class="row">
            <div class="col-lg-12">
                <x-breadcrumb :items="[
                    ...
                    ['title' => isset($department) ? trans('categorymanagment::department.edit_department') : trans('categorymanagment::department.create_department')]
                ]" />
            </div>
        </div>
                                    ...
                                    <div class="col-md-6 mb-25">
                                        <div class="form-group">
                                            ...
                                            <textarea 
                                                   ...
                                                   @if($language->rtl) dir="rtl" @endif
                                                   data-lang="{{ $language->code }}">{{ isset($department) ? ($department->getTranslation('description', $language->code) ?? '') : old('translations.' . $language->id . '.description') }}</textarea>
