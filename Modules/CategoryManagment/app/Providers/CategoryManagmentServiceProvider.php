...
namespace Modules\CategoryManagment\app\Providers;
...
class CategoryManagmentServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CategoryManagment';

    protected string $nameLower = 'categorymanagment';
