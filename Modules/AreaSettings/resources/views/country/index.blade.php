...
@section('content')
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="active" class="il-gray fs-14 fw-500 mb-10">{{ __('areasettings::country.status') }}</label>
                        ...
                        <table id="countriesDataTable" class="table mb-0 table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    @endforeach
                                    <th>
                                        <span class="userDatatable-title">{{ __('areasettings::country.country_code') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('areasettings::country.phone_code') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('areasettings::country.active') }}</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">{{ __('areasettings::country.created_at') }}</span>
                                    </th>
                                    <th>
    ...
    <x-delete-modal 
        ...
        :title="__('areasettings::country.confirm_delete')"
        :message="__('areasettings::country.delete_confirmation')"
        itemNameId="delete-country-name"
        confirmBtnId="confirmDeleteCountryBtn"
        :deleteRoute="route('admin.area-settings.countries.index')"
        :cancelText="__('areasettings::country.cancel')"
        :deleteText="__('areasettings::country.delete_country')"
    />
@endsection
