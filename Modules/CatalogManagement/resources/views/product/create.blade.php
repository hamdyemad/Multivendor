                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-switch form-switch-lg">
                                                        <input class="form-check-input" type="checkbox" role="switch"
                                                            ...
                                                            @if (isset($product) && ($product->product ? $product->product->is_featured : $product->is_featured)) checked @endif>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            @foreach ($languages as $language)
                                                <div
                                                    ...
                                                    @else
                                                        ...
                                                        <div>
                                                            <x-tags-input name="translations[{{ $language->id }}][tags]"
                                                                :value="isset($product)
                                                                    ? (isset($product->product) &&
                                                                    method_exists($product->product, 'getTagsString')
                                                                        ? $product->product->getTagsString(
                                                                            $language->code,
                                                                        )
                                                                        : (method_exists($product, 'getTagsString')
                                                                            ? $product->getTagsString($language->code)
                                                                            : ''))
                                                                    : old(
                                                                        'translations.' . $language->id . '.tags',
                                                                        '',
                                                                    )"
                                                        ...
                                                        <small class="text-muted w-100 d-block"
                                                            @if ($language->code == 'ar') dir="rtl" style="text-align: right;" @endif>{{ $language->code == 'ar' ? 'اضغط انتر أو فاصلة لإنشاء وسم' : 'Press Enter or comma to create a tag' }}</small>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <x-image-upload id="main_image" name="main_image"
                                                    label="{{ __('common.product_image') }}" :required="true"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="details_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('common.details') }} ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <textarea name="translations[{{ $language->id }}][details]" id="details_{{ $language->code }}"
                                                            class="form-control ih-medium ip-gray radius-xs b-light px-15 tinymce-editor" rows="6"
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-details"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="summary_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('common.summary') }} ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <textarea name="translations[{{ $language->id }}][summary]" id="summary_{{ $language->code }}"
                                                            class="form-control ih-medium ip-gray radius-xs b-light px-15 tinymce-editor" rows="4"
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-summary"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="features_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('common.features') }}
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-features"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="instructions_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-instructions"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="extra_description_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('catalogmanagement::product.extra_description') }}
                                                            ({{ strtoupper($language->code) }})
                                                        </label>
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-extra_description"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            @foreach ($languages as $language)
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="material_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('catalogmanagement::product.material') }}
                                                            ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <textarea name="translations[{{ $language->id }}][material]" id="material_{{ $language->code }}"
                                                            class="form-control ih-medium ip-gray radius-xs b-light px-15 tinymce-editor" rows="3"
                                                        ...
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-material"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            @endforeach
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="variants-empty-state" class="text-center py-4">
                                                ...
                                                <p class="text-muted mb-0">
                                                    {{ __('catalogmanagement::product.no_variants_added') }}</p>
                                            </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="meta_title_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('catalogmanagement::product.meta_title') }}
                                                            ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <input type="text"
                                                            ...
                                                            dir="{{ $language->code == 'ar' ? 'rtl' : 'ltr' }}">
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-meta_title"
                                                            style="display: none;"></div>
                                                        <small
                                                            class="text-muted">{{ __('common.recommended_50_60_chars') }}</small>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="meta_description_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('catalogmanagement::product.meta_description') }}
                                                            ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <textarea name="translations[{{ $language->id }}][meta_description]" id="meta_description_{{ $language->code }}"
                                                            ...
                                                            placeholder="{{ $language->code == 'ar' ? 'أدخل الوصف الوصفي' : 'Enter meta description' }}" maxlength="160"
                                                            dir="{{ $language->code == 'ar' ? 'rtl' : 'ltr' }}"></textarea>
                                                        <div class="error-message text-danger"
                                                            id="error-translations-{{ $language->id }}-meta_description"
                                                            style="display: none;"></div>
                                                        <small
                                                            class="text-muted">{{ __('common.recommended_150_160_chars') }}</small>
                                                    </div>
                                                </div>
                                            @endforeach
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label for="meta_keywords_{{ $language->code }}"
                                                            class="form-label w-100 {{ $language->rtl ? 'text-end' : '' }}">
                                                            {{ __('catalogmanagement::product.meta_keywords') }}
                                                            ({{ strtoupper($language->code) }})
                                                        </label>
                                                        <div @if ($language->code == 'ar') dir="rtl" @endif>
                                                            <x-tags-input
                                                                ...
                                                                :value="isset($product)
                                                                    ...
                                                                    method_exists(
                                                                        $product->product,
                                                                        'getMetaKeywordsString',
                                                                    )
                                                                        ? $product->product->getMetaKeywordsString(
                                                                            $language->code,
                                                                        )
                                                                        : (method_exists(
                                                                            $product,
                                                        ...
                                                        <small class="text-muted w-100 d-block"
                                                            @if ($language->code == 'ar') dir="rtl" style="text-align: right;" @endif>{{ $language->code == 'ar' ? 'اضغط انتر أو فاصلة لإنشاء كلمة مفتاحية' : 'Press Enter or comma to create a keyword' }}</small>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                            ...
                                            <table class="table table-bordered stock-table">
                                                ...
                                                <tfoot>
                                                    <tr class="table-active">
                                                        <td class="text-end">
                                                            <strong>{{ __('catalogmanagement::product.total_quantity') }}</strong>
                                                        </td>
                        ...
                        if (!mainImageInput.files || mainImageInput.files.length === 0) {
                            if (!hasExistingImage) {
                                ...
                                if ($errorContainer.length === 0) {
                                    ...
                                    $errorContainer.text('{{ __('catalogmanagement::product.main_image_required') }}')
                                        .show();
                                }
                                isValid = false;
                            }
                                    ...
                                    $('.variant-box').each(function() {
                                        ...
                                        if (!isBankProduct && !keySelected) {
                                            $variant.find('.variant-key-select').next('.select2').find(
                                                '.select2-selection').addClass('is-invalid');
                                            errors.push(
                                                `Variant #${variantIndex + 1}: {{ __('catalogmanagement::product.variant_key_required') }}`
                                            );
                                            isValid = false;
                                        }
                                        ...
                                        if (!valueId) {
                                            errors.push(
                                                `Variant #${variantIndex + 1}: {{ __('catalogmanagement::product.variant_selection_required') }}`
                                            );
                                            isValid = false;
                                        }
                                        ...
                                        if ($pricingStock.is(':visible')) {
                                            ...
                                            if (!sku || !sku.trim()) {
                                                ...
                                                $pricingStock.find('.sku-input').next('.error-message').text(
                                                        '{{ __('catalogmanagement::product.sku_required') }}')
                                                    .show();
                                                errors.push(
                                                    `Variant #${variantIndex + 1}: {{ __('catalogmanagement::product.sku_required') }}`
                                                );
                                                isValid = false;
                                            }
                                            ...
                                            if (!price || parseFloat(price) < 0) {
                                                ...
                                                $pricingStock.find('.price-input').next('.error-message').text(
                                                    '{{ __('catalogmanagement::product.price_required') }}'
                                                ).show();
                                                errors.push(
                                                    `Variant #${variantIndex + 1}: {{ __('catalogmanagement::product.price_required') }}`
                                                );
                                                isValid = false;
                                            }
                                            ...
                                            if (stockRows === 0) {
                                                errors.push(
                                                    `Variant #${variantIndex + 1}: {{ __('catalogmanagement::product.stock_required') }}`
                                                );
                                                isValid = false;
                                            } else {
                                                // Validate each stock row
        ...
        `;
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.add-stock-row', function() {
                    ...
                    console.log('Add stock row clicked', {
                        containerId,
                        namePrefix
                    });
                    addStockRow(containerId, namePrefix);
