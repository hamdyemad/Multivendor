...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        .auth-image {
            flex: 1;
            background: url("<?php echo e(asset('assets/img/electrical.avif')); ?>") center center/cover no-repeat;
            display: flex;
        ...
        <div class="auth-card">
            ...
            <div class="auth-form">
                ...
                <div style="text-align: center; margin-bottom: 30px;">
                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="svg" style="width: 100px;">
                </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="forgot-pass mb-3">
                        <a href="<?php echo e(route('forgetPassword.index')); ?>">Forgot password?</a>
                    </div>
...
<?php echo $__env->make('auth.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\eramo-multi-vendor\resources\views/auth/login.blade.php ENDPATH**/ ?>